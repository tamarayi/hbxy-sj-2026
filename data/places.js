/* ==========================================================================
   ...
   【坐标】已换算为高德坐标系（GCJ-02）。油石乡、油石嶂、营前镇、东山镇、梅水乡为 OSM 实测；
         茶博馆、制茶加工厂、上犹臻品体验中心均位于笔架山“两山”产业园（上犹初心农业开发有限公司东北约160米）；
         学校地址为赣州经开区东江源大道555号；河唇村、水村村等按政府公开村情简介推算。
   ...
   ====================================================================== */
{
  ...
  places: [
...

    {
      name: "茶博馆 · 传统文化研学",
      short: "茶文化研学",
      coords: [25.8925, 114.5575],   // 笔架山“两山”产业园（上犹初心农业开发有限公司东北约160米），三点稍作散开避免重叠
      summary: "走进茶博馆，开展中华传统茶文化研学。",
      intro: "实践队走进位于笔架山“两山”产业园的茶博馆开展传统文化研学，系统了解上犹茶产业的发展脉络与制茶工艺沿革，在沉浸式体验中感受传统茶文化的魅力，把“两山”转化成果与乡土文化传承结合起来，拓宽乡土文化视野。\n\n",
      media: [
   ...
   ====================================================================== */
{
  ...
  places: [
...

    {
      name: "制茶加工厂",
      short: "观摩制茶",
      coords: [25.8952, 114.5568],   // 笔架山“两山”产业园（上犹初心农业开发有限公司东北约160米），三点稍作散开避免重叠
...

    {
      name: "上犹臻品体验中心",
      short: "助农直播",
      coords: [25.8905, 114.5545],   // 笔架山“两山”产业园（上犹初心农业开发有限公司东北约160米），三点稍作散开避免重叠
      summary: "走进上犹臻品体验中心，开展线上助农直播。",
      intro: "“上猷臻品”是上犹县打造的区域公用品牌。实践队走进位于笔架山“两山”产业园的上犹臻品体验中心，了解本地特色农产品的品牌运营与标准化建设情况，并利用晚间开展线上助农直播，推介本土特色茶叶及农产品，助力乡村特色产业发展。\n\n队员用青年视角为家乡好物代言，把生态优势转化为发展优势的“两山”转化路径落到具体实践中。\n\n",
      media: [
